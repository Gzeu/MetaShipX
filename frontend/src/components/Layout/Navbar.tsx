            ...
            {isLoggedIn ? (
              <Menu>
                ...
                <MenuList bg={useColorModeValue('white', 'gray.800')} borderColor={borderColor}>
                  ...
                  <MenuItem onClick={() => navigate('/marketplace')} icon={<Text>🛢️</Text>}>Navele Mele</MenuItem>
            ...
            <VStack spacing={2} align="stretch">
              ...
              <Box pt={4}>
                {isLoggedIn ? (
                  ...
                  <Button colorScheme="blue" w="full" onClick={() => { onWalletOpen(); onDrawerClose(); }}>
                    🔗 Conectează Wallet
                  </Button>
                )}
              </Box>
          ...
          <DrawerBody>
            <VStack spacing={4} pt={4}>
              ...
              <Box w="full" borderRadius="xl" border="1px" borderColor="blue.700" overflow="hidden">
                ...
                >
                  <Flex
                    p={4} align="center" gap={4} cursor="pointer" w="full"
                    _hover={{ bg: 'blue.900' }} transition="background 0.2s"
                  >
                    <Text fontSize="2xl">📱</Text>
              ...
              <Box w="full" borderRadius="xl" border="1px" borderColor="gray.700" overflow="hidden">
                ...
                >
                  <Flex
                    p={4} align="center" gap={4} cursor="pointer" w="full"
                    _hover={{ bg: 'gray.800' }} transition="background 0.2s"
                  >
                    <Text fontSize="2xl">🧩</Text>
                    <VStack align="start" spacing={0} flex={1}>
